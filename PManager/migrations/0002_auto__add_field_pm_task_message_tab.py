...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PM_Task_Message.tab'
        db.add_column(u'PManager_pm_task_message', 'tab',
                      self.gf('django.db.models.fields.CharField')(default='SO', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PM_Task_Message.tab'
        db.delete_column(u'PManager_pm_task_message', 'tab')
    ...
    models = {
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 12, 1, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'PManager.pm_task_message': {
            ...
            'tab': ('django.db.models.fields.CharField', [], {'default': "'SO'", 'max_length': '2'}),
        ...
        'PManager.pm_user': {
            ...
            'avatar_color': ('django.db.models.fields.CharField', [], {'default': "'#87CEEB'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
