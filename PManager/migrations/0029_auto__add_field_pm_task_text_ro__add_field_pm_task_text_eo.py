...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PM_Task.text_ro'
        db.add_column(u'PManager_pm_task', 'text_ro',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PM_Task.text_eo'
        db.add_column(u'PManager_pm_task', 'text_eo',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'PM_Task.text_ro'
        db.delete_column(u'PManager_pm_task', 'text_ro')

        # Deleting field 'PM_Task.text_eo'
        db.delete_column(u'PManager_pm_task', 'text_eo')
    ...
    models = {
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 11, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'PManager.pm_user': {
            ...
            'avatar_color': ('django.db.models.fields.CharField', [], {'default': "'#836fff'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
