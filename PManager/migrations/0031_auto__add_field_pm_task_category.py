...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PM_Task.category'
        db.add_column(u'PManager_pm_task', 'category',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='category', null=True, on_delete=models.SET_NULL, to=orm['PManager.PM_File_Category'], blank=True, unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PM_Task.category'
        db.delete_column(u'PManager_pm_task', 'category_id')
    ...
    models = {
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2021, 5, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
