...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PMTelegramUser.user'
        db.add_column(u'PManager_pmtelegramuser', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PMTelegramUser.user'
        db.delete_column(u'PManager_pmtelegramuser', 'user_id')
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 8, 10, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 8, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
