...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'PManager_credit', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='credits', null=True, to=orm['PManager.PM_Project'], blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='arrears', null=True, to=orm['auth.User'], blank=True)),
            ('payer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='credits', null=True, to=orm['auth.User'], blank=True)),
            ...
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name='costs', null=True, to=orm['PManager.PM_Task'], blank=True)),
        ))
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 2, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 2, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'PManager.pm_user': {
            ...
            'avatar_color': ('django.db.models.fields.CharField', [], {'default': "'#e0eee0'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
