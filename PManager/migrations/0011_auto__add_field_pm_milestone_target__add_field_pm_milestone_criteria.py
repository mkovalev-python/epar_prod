...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PM_Milestone.target'
        db.add_column(u'PManager_pm_milestone', 'target',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PM_Milestone.criteria'
        db.add_column(u'PManager_pm_milestone', 'criteria',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PM_Milestone.target'
        db.delete_column(u'PManager_pm_milestone', 'target')

        # Deleting field 'PM_Milestone.criteria'
        db.delete_column(u'PManager_pm_milestone', 'criteria')
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 5, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
