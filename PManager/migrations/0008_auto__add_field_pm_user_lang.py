...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PM_User.lang'
        db.add_column(u'PManager_pm_user', 'lang',
                      self.gf('django.db.models.fields.CharField')(default='ru', max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PM_User.lang'
        db.delete_column(u'PManager_pm_user', 'lang')
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 9, 17, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 9, 17, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
