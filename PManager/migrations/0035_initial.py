...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'PManager_pm_user', (
            ...
            ('avatar_color', self.gf('django.db.models.fields.CharField')(default='#eed5b7', max_length=20, null=True, blank=True)),
        ...
        db.create_table(u'PManager_pm_noticedusers', (
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2021, 5, 19, 0, 0))),
        ))
    ...
    models = {
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2021, 5, 19, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
