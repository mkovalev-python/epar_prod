...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PM_Milestone.id_md5'
        db.add_column(u'PManager_pm_milestone', 'id_md5',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PM_Milestone.id_md5'
        db.delete_column(u'PManager_pm_milestone', 'id_md5')
