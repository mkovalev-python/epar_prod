...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Credit.is_bonus'
        db.delete_column(u'PManager_credit', 'is_bonus')

        # Adding field 'Credit.code'
        db.add_column(u'PManager_credit', 'code',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Credit.is_bonus'
        db.add_column(u'PManager_credit', 'is_bonus',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Credit.code'
        db.delete_column(u'PManager_credit', 'code')
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 7, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 7, 6, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'PManager.pm_user': {
            ...
            'avatar_color': ('django.db.models.fields.CharField', [], {'default': "'#ffdead'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
