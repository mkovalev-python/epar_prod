...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'PManager_fee', (
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fee', null=True, to=orm['PManager.PM_Project'], blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fee', null=True, to=orm['auth.User'], blank=True)),
            ...
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fee', null=True, to=orm['PManager.PM_Task'], blank=True)),
        ))
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 5, 31, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 5, 31, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'PManager.pm_user': {
            ...
            'avatar_color': ('django.db.models.fields.CharField', [], {'default': "'#00cd66'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
