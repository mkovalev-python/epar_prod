...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PM_Milestone.is_half_completed'
        db.add_column(u'PManager_pm_milestone', 'is_half_completed',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PM_Milestone.is_has_grooming'
        db.add_column(u'PManager_pm_milestone', 'is_has_grooming',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PM_Milestone.delay_factor'
        db.add_column(u'PManager_pm_milestone', 'delay_factor',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PM_Milestone.g_factor'
        db.add_column(u'PManager_pm_milestone', 'g_factor',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PM_Milestone.is_half_completed'
        db.delete_column(u'PManager_pm_milestone', 'is_half_completed')

        # Deleting field 'PM_Milestone.is_has_grooming'
        db.delete_column(u'PManager_pm_milestone', 'is_has_grooming')

        # Deleting field 'PM_Milestone.delay_factor'
        db.delete_column(u'PManager_pm_milestone', 'delay_factor')

        # Deleting field 'PM_Milestone.g_factor'
        db.delete_column(u'PManager_pm_milestone', 'g_factor')
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 6, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'final_delay': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 6, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
