...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'PManager_pm_user', (
            ...
            ('avatar_color', self.gf('django.db.models.fields.CharField')(default='#76ee00', max_length=20, null=True, blank=True)),
    ...
    models = {
        ...
        'PManager.pm_user': {
            ...
            'avatar_color': ('django.db.models.fields.CharField', [], {'default': "'#eed5b7'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
