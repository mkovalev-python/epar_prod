...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RatingHits'
        # db.delete_table(u'PManager_ratinghits')
        #
        # # Deleting model 'LikesHits'
        # db.delete_table(u'PManager_likeshits')

        # Deleting model 'PM_Project_Industry'
        # db.delete_table(u'PManager_pm_project_industry')

        # Deleting field 'Specialty.parent'
        # db.delete_column(u'PManager_specialty', 'parent_id')

        # Removing M2M table for field connected on 'Specialty'
        # db.delete_table(db.shorten_name(u'PManager_specialty_connected'))

        # Deleting field 'PM_Project.blockchain_name'
        # db.delete_column(u'PManager_pm_project', 'blockchain_name')

        # Deleting field 'PM_Project.link_github'
        db.delete_column(u'PManager_pm_project', 'link_github')

        # Deleting field 'PM_Project.target_group'
        db.delete_column(u'PManager_pm_project', 'target_group')

        # Deleting field 'PM_Project.link_demo'
        db.delete_column(u'PManager_pm_project', 'link_demo')

        # Deleting field 'PM_Project.link_site'
        db.delete_column(u'PManager_pm_project', 'link_site')

        # Deleting field 'PM_Project.problem'
        db.delete_column(u'PManager_pm_project', 'problem')

        # Removing M2M table for field industries on 'PM_Project'
        db.delete_table(db.shorten_name(u'PManager_pm_project_industries'))

        # Removing M2M table for field files on 'PM_Project'
        db.delete_table(db.shorten_name(u'PManager_pm_project_files'))

        # Removing M2M table for field specialties on 'PM_Project'
        db.delete_table(db.shorten_name(u'PManager_pm_project_specialties'))

        # Deleting field 'Tags.parent'
        db.delete_column(u'PManager_tags', 'parent_id')

        # Deleting field 'PM_User.blockchain_key'
        db.delete_column(u'PManager_pm_user', 'blockchain_key')

        # Deleting field 'PM_User.blockchain_cert'
        db.delete_column(u'PManager_pm_user', 'blockchain_cert')

        # Deleting field 'PM_User.blockchain_wallet'
        db.delete_column(u'PManager_pm_user', 'blockchain_wallet')

        # Deleting field 'PM_Milestone.description'
        db.delete_column(u'PManager_pm_milestone', 'description')

        # Deleting field 'PM_Milestone.token_price'
        db.delete_column(u'PManager_pm_milestone', 'token_price')

        # Deleting field 'PM_Milestone.author'
        db.delete_column(u'PManager_pm_milestone', 'author_id')


    def backwards(self, orm):
        # Adding model 'RatingHits'
        db.create_table(u'PManager_ratinghits', (
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ratingHits', to=orm['PManager.PM_Project'])),
            ('ip', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rating', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('PManager', ['RatingHits'])

        # Adding model 'LikesHits'
        db.create_table(u'PManager_likeshits', (
            ('ip', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('milestone', self.gf('django.db.models.fields.related.ForeignKey')(related_name='likesHits', to=orm['PManager.PM_Milestone'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('PManager', ['LikesHits'])

        # Adding model 'PM_Project_Industry'
        db.create_table(u'PManager_pm_project_industry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='problems', null=True, to=orm['PManager.PM_Project_Industry'], blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('PManager', ['PM_Project_Industry'])

        # Adding field 'Specialty.parent'
        db.add_column(u'PManager_specialty', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='subspecialties', null=True, to=orm['PManager.Specialty'], blank=True),
                      keep_default=False)

        # Adding M2M table for field connected on 'Specialty'
        m2m_table_name = db.shorten_name(u'PManager_specialty_connected')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_specialty', models.ForeignKey(orm['PManager.specialty'], null=False)),
            ('to_specialty', models.ForeignKey(orm['PManager.specialty'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_specialty_id', 'to_specialty_id'])

        # Adding field 'PM_Project.blockchain_name'
        db.add_column(u'PManager_pm_project', 'blockchain_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PM_Project.link_github'
        db.add_column(u'PManager_pm_project', 'link_github',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'PM_Project.target_group'
        db.add_column(u'PManager_pm_project', 'target_group',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PM_Project.link_demo'
        db.add_column(u'PManager_pm_project', 'link_demo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'PM_Project.link_site'
        db.add_column(u'PManager_pm_project', 'link_site',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'PM_Project.problem'
        db.add_column(u'PManager_pm_project', 'problem',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field industries on 'PM_Project'
        m2m_table_name = db.shorten_name(u'PManager_pm_project_industries')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pm_project', models.ForeignKey(orm['PManager.pm_project'], null=False)),
            ('pm_project_industry', models.ForeignKey(orm['PManager.pm_project_industry'], null=False))
        ))
        db.create_unique(m2m_table_name, ['pm_project_id', 'pm_project_industry_id'])

        # Adding M2M table for field files on 'PM_Project'
        m2m_table_name = db.shorten_name(u'PManager_pm_project_files')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pm_project', models.ForeignKey(orm['PManager.pm_project'], null=False)),
            ('pm_files', models.ForeignKey(orm['PManager.pm_files'], null=False))
        ))
        db.create_unique(m2m_table_name, ['pm_project_id', 'pm_files_id'])

        # Adding M2M table for field specialties on 'PM_Project'
        m2m_table_name = db.shorten_name(u'PManager_pm_project_specialties')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pm_project', models.ForeignKey(orm['PManager.pm_project'], null=False)),
            ('specialty', models.ForeignKey(orm['PManager.specialty'], null=False))
        ))
        db.create_unique(m2m_table_name, ['pm_project_id', 'specialty_id'])

        # Adding field 'Tags.parent'
        db.add_column(u'PManager_tags', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='subtags', null=True, to=orm['PManager.Tags'], blank=True),
                      keep_default=False)

        # Adding field 'PM_User.blockchain_key'
        db.add_column(u'PManager_pm_user', 'blockchain_key',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PM_User.blockchain_cert'
        db.add_column(u'PManager_pm_user', 'blockchain_cert',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PM_User.blockchain_wallet'
        db.add_column(u'PManager_pm_user', 'blockchain_wallet',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PM_Milestone.description'
        db.add_column(u'PManager_pm_milestone', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PM_Milestone.token_price'
        db.add_column(u'PManager_pm_milestone', 'token_price',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PM_Milestone.author'
        db.add_column(u'PManager_pm_milestone', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='createdMilestones', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 2, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 2, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'PManager.pm_user': {
            ...
            'avatar_color': ('django.db.models.fields.CharField', [], {'default': "'#F0E68C'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
