...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Credit.milestone'
        db.add_column(u'PManager_credit', 'milestone',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='credits', null=True, to=orm['PManager.PM_Milestone']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Credit.milestone'
        db.delete_column(u'PManager_credit', 'milestone_id')
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 6, 13, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 6, 13, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
