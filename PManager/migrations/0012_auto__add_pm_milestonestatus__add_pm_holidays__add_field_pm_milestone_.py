...
#        db.send_create_signal('PManager', ['PM_Holidays'])
        ...
        # Adding field 'PM_Milestone.extra_hours'
#        db.add_column(u'PManager_pm_milestone', 'extra_hours',
#                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
#                      keep_default=False)

        # Adding field 'PM_Milestone.delay_deduction'
#        db.add_column(u'PManager_pm_milestone', 'delay_deduction',
#                      self.gf('django.db.models.fields.IntegerField')(default=0),
#                      keep_default=False)

        # Adding field 'PM_Milestone.manager'
#        db.add_column(u'PManager_pm_milestone', 'manager',
#                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='milestones', null=True, to=orm['auth.User']),
#                      keep_default=False)

        # Adding field 'PM_Milestone.type'
#        db.add_column(u'PManager_pm_milestone', 'type',
#                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=25, null=True, blank=True),
#                      keep_default=False)

        # Adding field 'PM_Milestone.fact_close_date'
#        db.add_column(u'PManager_pm_milestone', 'fact_close_date',
...
#                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PM_Milestone.extra_hours'
        db.delete_column(u'PManager_pm_milestone', 'extra_hours')

        # Deleting field 'PM_Milestone.delay_deduction'
        db.delete_column(u'PManager_pm_milestone', 'delay_deduction')

        # Deleting field 'PM_Milestone.manager'
        db.delete_column(u'PManager_pm_milestone', 'manager_id')

        # Deleting field 'PM_Milestone.type'
        db.delete_column(u'PManager_pm_milestone', 'type')

        # Deleting field 'PM_Milestone.fact_close_date'
        db.delete_column(u'PManager_pm_milestone', 'fact_close_date')
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
