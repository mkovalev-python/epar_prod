...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'PManager_feedback', 'rating',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)

        # Adding field 'Feedback.notes_was'
        db.add_column(u'PManager_feedback', 'notes_was',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True),
                      keep_default=False)

        # Adding field 'Feedback.notes_do'
        db.add_column(u'PManager_feedback', 'notes_do',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'PManager_feedback', 'rating')

        # Deleting field 'Feedback.notes_was'
        db.delete_column(u'PManager_feedback', 'notes_was')

        # Deleting field 'Feedback.notes_do'
        db.delete_column(u'PManager_feedback', 'notes_do')
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 2, 14, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 2, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'PManager.pm_user': {
            ...
            'avatar_color': ('django.db.models.fields.CharField', [], {'default': "'#76ee00'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
