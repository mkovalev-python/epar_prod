...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PM_Task.planTimeMainOrg'
        db.add_column(u'PManager_pm_task', 'planTimeMainOrg',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PM_Task.planTimeRegulator'
        db.add_column(u'PManager_pm_task', 'planTimeRegulator',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PM_Milestone.file_for_client'
        db.add_column(u'PManager_pm_milestone', 'file_for_client',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PM_Task.planTimeMainOrg'
        db.delete_column(u'PManager_pm_task', 'planTimeMainOrg')

        # Deleting field 'PM_Task.planTimeRegulator'
        db.delete_column(u'PManager_pm_task', 'planTimeRegulator')

        # Deleting field 'PM_Milestone.file_for_client'
        db.delete_column(u'PManager_pm_milestone', 'file_for_client')
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 10, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 10, 26, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
