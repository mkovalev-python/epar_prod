...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PM_Milestone.is_close_confirmed'
        db.add_column(u'PManager_pm_milestone', 'is_close_confirmed',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PM_Milestone.is_close_confirmed'
        db.delete_column(u'PManager_pm_milestone', 'is_close_confirmed')
    ...
    models = {
        ...
        'PManager.pm_milestone': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 8, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'PManager.pm_milestonedevpaymentapproval': {
            'Meta': {'object_name': 'PM_MilestoneDevPaymentApproval'},
        ...
        'PManager.pm_noticedusers': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 8, 25, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'PManager.pm_user': {
            ...
            'avatar_color': ('django.db.models.fields.CharField', [], {'default': "'#eedc82'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
