...
SOCKET_SERVER_ADDRESS = env('SOCKET_SERVER_ADDRESS', default='95.163.242.133')

# Server root url
SERVER_ROOT_URL = env('SERVER_ROOT_URL', default='95.163.242.133')
HTTP_ROOT_URL = env('HTTP_ROOT_URL', default='http://95.163.242.133')
SERVER_IP = env('SERVER_IP', default='95.163.242.133')
...
# todo: ADD DESCRIPTION
SESSION_COOKIE_DOMAIN = '95.163.242.133'
CSRF_COOKIE_NAME = '95.163.242.133'
# ######################### REDIS SETTINGS ##############################
# REDIS SERVER HOST
